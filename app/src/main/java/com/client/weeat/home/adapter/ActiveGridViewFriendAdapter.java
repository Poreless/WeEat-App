 ...
 * @updateDes ${TODO}
 */
public class ActiveGridViewFriendAdapter extends BaseAdapter {
    private final Context mcontext;
    private final List<ResultBeanDate.ResultBean.ActiveFriendBean> datas;

    public ActiveGridViewFriendAdapter(Context mcontext, List<ResultBeanDate.ResultBean.ActiveFriendBean> active_info) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ResultBeanDate.ResultBean.ActiveFriendBean activeInfoBean = datas.get(position);
        //根据位置得到对应的数据
        try {
