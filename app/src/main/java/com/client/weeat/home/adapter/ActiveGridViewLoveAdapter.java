 ...
 * @updateDes ${TODO}
 */
public class ActiveGridViewLoveAdapter extends BaseAdapter {
    private final Context mcontext;
    private final List<ResultBeanDate.ResultBean.ActiveLoveBean> datas;

    public ActiveGridViewLoveAdapter(Context mcontext, List<ResultBeanDate.ResultBean.ActiveLoveBean> active_info) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ResultBeanDate.ResultBean.ActiveLoveBean activeInfoBean = datas.get(position);
        //根据位置得到对应的数据
        try {
