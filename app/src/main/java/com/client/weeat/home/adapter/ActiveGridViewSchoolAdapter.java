 ...
 * @updateDes ${TODO}
 */
public class ActiveGridViewSchoolAdapter extends BaseAdapter {
    private final Context mcontext;
    private final List<ResultBeanDate.ResultBean.ActiveSchoolBean> datas;

    public ActiveGridViewSchoolAdapter(Context mcontext, List<ResultBeanDate.ResultBean.ActiveSchoolBean> active_info) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ResultBeanDate.ResultBean.ActiveSchoolBean activeInfoBean = datas.get(position);
        //根据位置得到对应的数据
        try {
