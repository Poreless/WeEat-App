 ...
 * @updateDes ${TODO}
 */
public class EDListAdapter extends BaseExpandableListAdapter{

    private final Context mcontext;
    private final List<CommentBeanDate.ResultBean.ActiveCommentBean> datas;
    public EDListAdapter(Context mcontext, List<CommentBeanDate.ResultBean.ActiveCommentBean> commentinfo) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        //根据位置得到对应的数据
        CommentBeanDate.ResultBean.ActiveCommentBean commentInfo = datas.get(groupPosition);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        //根据位置得到对应的数据
        CommentBeanDate.ResultBean.ActiveCommentBean.CommentlistBean commentlistInfo = datas.get(groupPosition).getCommentlist().get(childPosition);
